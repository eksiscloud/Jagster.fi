...
INPUT_DIR = "/root/wordpress-export-to-markdown/jagster_export/markdown/posts"
OUTPUT_DIR = "/root/wordpress-export-to-markdown/jagster_export/markdown/categorized"
